...
val parses = "uniqueWords100.tsv"
val sourceText = "OCRText100.tsv"
...
val lemmaWords = surfWords.map ( _.map { s => swapInParse(s,parseVector) } )

println(lemmaWords.map(_.mkString(" ")))
